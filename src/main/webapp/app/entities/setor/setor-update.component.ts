...
export class SetorUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    nomeSetor: [null, [Validators.required]],
    codigoSetor: [null, [Validators.required]],
  ...
  private createFromForm(): ISetor {
    return {
      ...
      nomeSetor: this.editForm.get(['nomeSetor']).value,
      codigoSetor: this.editForm.get(['codigoSetor']).value,
